...
window.BM_LESSONS = [
    ...
    "timeline": [
      {
        ...
        "description": "Tarquin the Proud is expelled; first consuls take office."
      },
      {
        "year": "494 BC",
        "title": "First Secession of the Plebs",
        "description": "Creation of the Tribune of the Plebs."
      },
      {
        "year": "450 BC",
        "title": "Twelve Tables",
        "description": "Rome's first written law code."
      },
      {
        "year": "264–146 BC",
        "title": "Punic Wars",
        "description": "Rome defeats Carthage and dominates the west Mediterranean."
      },
      {
        "year": "49 BC",
        "title": "Caesar Crosses the Rubicon",
        "description": "Civil war that ends the Republic."
      },
      {
        "year": "27 BC",
        "title": "Augustus",
    ...
    "figures": [
      {
        ...
        "role": "Founder & First Consul",
        "bio": "Led the revolt against Tarquin. Symbol of republican virtue."
      },
      {
        "name": "Cincinnatus",
        "role": "Model Dictator",
        "bio": "Saved Rome then returned to his farm — ideal of civic duty."
      },
      {
        "name": "Julius Caesar",
        "role": "The Man Who Ended It",
        "bio": "Crossed the Rubicon. Dictatorship ends the Republic."
      }
    ],
    "quiz": [
      {
    ...
    "timeline": [
      {
        ...
        "description": "Third Dynasty under Djoser; Step Pyramid at Saqqara."
      },
      {
        "year": "c. 2580 BC",
        "title": "Great Pyramid",
        "description": "Khufu builds the largest pyramid."
      },
      {
        "year": "c. 2181 BC",
        "title": "Old Kingdom Ends",
        "description": "Central authority collapses."
      }
    ],
    "figures": [
      {
        "name": "Djoser",
        "role": "Pharaoh",
        "bio": "Commissioned the first pyramid complex."
      },
      {
        "name": "Imhotep",
        "role": "Architect & Vizier",
        "bio": "Designed the Step Pyramid; later deified."
      },
      {
        "name": "Khufu",
        "role": "Builder of the Great Pyramid",
        "bio": "Fourth Dynasty pharaoh."
      }
    ],
    "quiz": [
      {
    ...
    "timeline": [
      {
        ...
        "description": "Village networks densify toward urbanism."
      },
      {
        "year": "c. 2600 BC",
        "title": "Mature Harappan",
        "description": "Great cities at peak organization and trade."
      },
      {
        "year": "c. 1900 BC",
        "title": "Transformation",
        "description": "Urban centers fade; regional cultures emerge."
      },
      {
        "year": "1920s",
        "title": "Modern Discovery",
        "description": "Excavations reveal Harappa and Mohenjo-daro to the world."
      }
    ],
    "figures": [
      {
        "name": "John Marshall",
        "role": "Archaeologist",
        "bio": "Director-General of the ASI; announced the civilization publicly in the 1920s."
      },
      {
        "name": "R. D. Banerji",
        "role": "Excavator",
        "bio": "Early work at Mohenjo-daro helped identify the culture."
      },
      {
        "name": "Dayaram Sahni",
        "role": "Excavator",
        "bio": "Key early excavations at Harappa."
      }
    ],
    "quiz": [
      {
        ...
        "options": [
          "Pyramid tombs",
          "Grid planning and drains",
          "Marble amphitheaters",
    ...
    "timeline": [
      {
        ...
        "description": "Chandragupta establishes Mauryan power."
      },
      {
        "year": "c. 261 BC",
        "title": "Kalinga War",
        "description": "Ashoka's costly victory; turning point in royal ideology."
      },
      {
        "year": "c. 250s BC",
        "title": "Edicts",
        "description": "Dhamma messages carved on rocks and pillars."
      },
      {
        "year": "c. 185 BC",
        "title": "Mauryan Fall",
        "description": "Pushyamitra Shunga ends the dynasty."
      }
    ],
    "figures": [
      {
        ...
        "role": "Founder",
        "bio": "Built the empire that Ashoka would inherit."
      },
      {
        "name": "Chanakya (Kautilya)",
        "role": "Strategist",
        "bio": "Advisor associated with Arthashastra statecraft."
      },
      {
        "name": "Ashoka",
        "role": "Emperor",
        "bio": "Expanded then redefined imperial purpose through dhamma."
      }
    ],
    "quiz": [
      {
  ...
  },
  {
    ...
    "timeline": [
      {
        "year": "2nd c. BC",
        "title": "Han Expansion West",
        "description": "Chinese engagement with Central Asia intensifies exchange."
      },
      {
        "year": "1st–3rd c. AD",
        "title": "Kushan Hub",
        "description": "Central Asian power bridges India, China, and Iran."
      },
      {
        "year": "7th–9th c.",
        "title": "Abbasid Age",
        "description": "Baghdad and Central Asian cities thrive as trade nodes."
      },
      {
        "year": "13th c.",
        "title": "Pax Mongolica",
        "description": "Mongol peace lowers barriers for merchants and missionaries."
      }
    ],
    "figures": [
      {
        "name": "Zhang Qian",
        "role": "Han Envoy",
        "bio": "Missions westward opened Chinese knowledge of Central Asia."
      },
      {
        "name": "Xuanzang",
        "role": "Buddhist Pilgrim",
        "bio": "7th-century journey to India became a classic of travel and faith."
      },
      {
        "name": "Ibn Battuta",
        "role": "Traveler",
        "bio": "14th-century journeys mapped a connected Afro-Eurasian world."
      }
    ],
    "quiz": [
      {
    ...
    "timeline": [
      {
        "year": "c. 1235",
        "title": "Sundiata",
        "description": "Foundations of Mali after victory at Kirina (tradition)."
      },
      {
        "year": "c. 1312–1337",
        "title": "Mansa Musa",
        "description": "Reign at Mali's height of fame."
      },
      {
        "year": "c. 1324",
        "title": "Hajj",
        "description": "Pilgrimage becomes a pan-Mediterranean story."
      },
      {
        "year": "15th–16th c.",
        "title": "Shift",
        "description": "Songhai and changing trade routes reshape the region."
      }
    ],
    "figures": [
      {
        "name": "Sundiata Keita",
        "role": "Founder (epic tradition)",
        "bio": "Hero of the Epic of Sundiata; associated with Mali's rise."
      },
      {
        "name": "Mansa Musa",
        "role": "Emperor",
        "bio": "Famous for pilgrimage, patronage, and imperial wealth."
      },
      {
        "name": "Ibn Khaldun",
        "role": "Historian",
        "bio": "North African scholar whose works reference Western Sudanese states."
      }
    ],
    "quiz": [
      {
        ...
        "options": [
          ...
          "Hajj to Mecca",
          "Conquest of Rome",
          "Silk Road caravan to Samarkand"
        ],
        "answer": 1,
    ...
    "timeline": [
      {
        ...
        "description": "Latins sack Constantinople; Byzantium fatally weakened."
      },
      {
        "year": "1451",
        "title": "Mehmed II",
        "description": "Young sultan prepares a decisive campaign."
      },
      {
        "year": "6 Apr–29 May 1453",
        "title": "Siege",
        "description": "Artillery and assaults break the city's defenses."
      },
      {
        "year": "1453+",
        "title": "New Capital",
        "description": "Ottomans remake the city as imperial center."
      }
    ],
    "figures": [
      {
        "name": "Mehmed II",
        "role": "Ottoman Sultan",
        "bio": "Conqueror who made the city his capital."
      },
      {
        "name": "Constantine XI",
        "role": "Last Byzantine Emperor",
        "bio": "Died in the final defense of the city."
      },
      {
        "name": "Orban",
        "role": "Cannon Founder",
        "bio": "Associated with giant bombards used in the siege."
      }
    ],
    "quiz": [
      {
    ...
    "timeline": [
      {
        "year": "1526",
        "title": "First Panipat",
        "description": "Babur defeats the Lodi sultan; Mughal rule begins."
      },
      {
        "year": "1540–1555",
        "title": "Humayun's Exile",
        "description": "Sur dynasty interruption; Mughal restoration."
      },
      {
        "year": "1556–1605",
        "title": "Akbar",
        "description": "Expansion and administrative consolidation."
      },
      {
        "year": "1632–1653",
        "title": "Taj Mahal",
        "description": "Shah Jahan's mausoleum becomes a global icon."
      }
    ],
    "figures": [
      {
        "name": "Babur",
        "role": "Founder",
        "bio": "Timurid prince; memoirist and conqueror."
      },
      {
        "name": "Humayun",
        "role": "Emperor",
        "bio": "Lost then recovered the empire."
      },
      {
        "name": "Akbar",
        "role": "Consolidator",
        "bio": "Built the administrative and political foundations of high Mughal power."
      }
    ],
    "quiz": [
      {
  ...
  },
  {
    ...
    "timeline": [
      {
        "year": "1789",
        "title": "Estates-General & Bastille",
        "description": "Crisis becomes revolution."
      },
      {
        "year": "1792–94",
        "title": "Republic & Terror",
        "description": "War and radical politics peak."
      },
      {
        "year": "1799",
        "title": "Brumaire",
        "description": "Napoleon seizes power."
      },
      {
        "year": "1804",
        "title": "Emperor",
        "description": "Napoleonic Empire; revolutionary aftershocks continue."
      }
    ],
    "figures": [
      {
        "name": "Louis XVI",
        "role": "King",
        "bio": "Monarch whose authority collapsed; executed 1793."
      },
      {
        "name": "Maximilien Robespierre",
        "role": "Jacobin Leader",
        "bio": "Symbol of revolutionary virtue and the Terror."
      },
      {
        "name": "Olympe de Gouges",
        "role": "Writer",
        "bio": "Demanded women's rights; executed during the Terror."
      }
    ],
    "quiz": [
      {
    ...
    "timeline": [
      {
        ...
        "description": "Muslim League articulates demand for Muslim-majority states."
      },
      {
        "year": "1946",
        "title": "Cabinet Mission fails",
        "description": "Last major unity plans unravel."
      },
      {
        "year": "15 Aug 1947",
        "title": "Independence & Partition",
        "description": "Two dominions born; violence and migration surge."
      },
      {
        "year": "1947–48",
        "title": "Kashmir War",
        "description": "First India-Pakistan war over Kashmir."
      }
    ],
    "figures": [
      {
        "name": "Jawaharlal Nehru",
        "role": "First PM of India",
        "bio": "Led Congress into independence government."
      },
      {
        "name": "Muhammad Ali Jinnah",
        "role": "Leader of Pakistan movement",
        "bio": "First Governor-General of Pakistan."
      },
      {
        "name": "Mahatma Gandhi",
        "role": "Nationalist leader",
        "bio": "Opposed communal division; assassinated 1948."
      }
    ],
    "quiz": [
      {
  ...
  },
  {
    ...
    "timeline": [
      {
        "year": "Before 800",
        "title": "East Asian Print",
        "description": "Woodblock printing thrives in China and beyond."
      },
      {
        "year": "c. 1455",
        "title": "Gutenberg Bible",
        "description": "Icon of European moveable-type printing."
      },
      {
        "year": "1517+",
        "title": "Reformation Media",
        "description": "Pamphlets and vernacular Bibles spread rapidly."
      },
      {
        "year": "17th–18th c.",
        "title": "Periodicals",
        "description": "Newspapers and journals reshape public debate."
      }
    ],
    "figures": [
      {
        ...
        "role": "Printer",
        "bio": "Associated with the European moveable-type breakthrough."
      },
      {
        "name": "Martin Luther",
        "role": "Reformer",
        "bio": "Used print masterfully to spread religious challenge."
      },
      {
        "name": "Goryeo Korea",
        "role": "Innovation center",
        "bio": "Early moveable metal type tradition (e.g., Jikji, 1377)."
      }
    ],
    "quiz": [
      {
    ...
    "timeline": [
      {
        ...
        "description": "Molecular cloud collapses into Sun + disk."
      },
      {
        "year": "1969",
        "title": "Apollo 11",
        "description": "Humans walk on the Moon."
      },
      {
        "year": "1977",
        "title": "Voyager Launches",
        "description": "Grand tour of the outer planets begins."
      },
      {
        "year": "2015",
        "title": "New Horizons at Pluto",
        "description": "First close-ups of Pluto."
      }
    ],
    "figures": [
      {
        "name": "Copernicus",
        "role": "Heliocentric Revolution",
        "bio": "Put the Sun at the center."
      },
      {
        "name": "Galileo",
        "role": "Jupiter's Moons",
        "bio": "Telescope discoveries challenged geocentrism."
      },
      {
        "name": "Carl Sagan",
        "role": "Cosmic Communicator",
        "bio": "Made planetary science wonder accessible."
      }
    ],
    "quiz": [
      {
  ...
  },
  {
    ...
    "timeline": [
      ...
      },
      {
        "year": "1963",
        "title": "Kerr Solution",
        "description": "Rotating black holes."
      },
      {
        "year": "2019",
        "title": "First Image",
        "description": "EHT images M87*'s shadow."
      }
    ],
    "figures": [
      {
        "name": "Einstein",
        "role": "Relativity",
        "bio": "Predicted black holes mathematically."
      },
      {
        "name": "Stephen Hawking",
        "role": "Thermodynamics",
        "bio": "Black hole radiation & entropy."
      },
      {
        "name": "Ghez & Genzel",
        "role": "Galactic Center",
        "bio": "Stellar orbits prove Sgr A*."
      }
    ],
    "quiz": [
      {
...
window.BM_DAILY_FACTS = [
  {
    ...
    "text": "In Nineveh, Assyrian king Ashurbanipal collected thousands of clay tablets — one of the oldest 'libraries' we can still study."
  },
  {
    "title": "Zero's journey",
    "text": "The concept of zero as a number flowered in India and traveled through the Islamic world into Europe — reshaping mathematics."
  },
  {
    "title": "Antikythera mechanism",
    "text": "A 2,000-year-old Greek device recovered from a shipwreck tracked celestial cycles with gearwork centuries ahead of its time."
  },
  {
    "title": "Paper from the east",
    "text": "Paper-making knowledge moved from China along connected trade routes, eventually transforming record-keeping worldwide."
  },
  {
    "title": "Sailing by monsoon",
    "text": "Indian Ocean sailors timed voyages to monsoon winds — a climate technology as important as any compass."
  },
  {
    "title": "Cahokia's skyline",
    "text": "Near modern St. Louis, the city of Cahokia featured massive earthen mounds and a population rivaling medieval London at its peak."
  },
  {
    "title": "Jikji",
    "text": "The Korean book Jikji (1377) is the oldest known book printed with moveable metal type — predating Gutenberg's fame."
  },
  {
    "title": "House of Wisdom",
    "text": "In Abbasid Baghdad, scholars translated and extended Greek, Persian, and Indian knowledge in mathematics, medicine, and astronomy."
  },
  {
    "title": "Inca roads",
    "text": "The Andean road system (Qhapaq Ñan) knitted an empire across mountains without wheeled transport or horses in daily logistics."
  },
  {
    "title": "Rosetta Stone",
    "text": "A decree in three scripts let Champollion crack Egyptian hieroglyphs — turning mute walls into readable history."
  },
  {
    "title": "Coffeehouse politics",
    "text": "Early modern coffeehouses from Istanbul to London became 'penny universities' where news and arguments brewed."
  },
  {
    "title": "Map that renamed a continent",
    "text": "Waldseemüller's 1507 map is among the first to label 'America' — a reminder that maps invent as much as they describe."
  },
  {
    "title": "Salt as power",
    "text": "Across the Sahara, salt was once valued like gold — a reminder that 'wealth' is always a cultural equation."
  },
  {
    "title": "Voynich mystery",
    "text": "The Voynich Manuscript remains undeciphered — a medieval puzzle that keeps cryptographers and historians humble."
  },
  {
    "title": "Beringia",
    "text": "During ice ages, lower seas exposed Beringia — a land bridge corridor linking Asia and the Americas for human migration."
  }
];
